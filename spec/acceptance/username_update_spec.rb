...
As some user I want to be able to update user_name} do
  ...
  scenario 'User is trying to search change user_name for commit', js: true do
    visit import_commits_path
